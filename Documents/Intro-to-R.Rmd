...
This code installs the R packages named `dplyr` and `ggplot2`. These packages are
libraries of functions that are used for data manipulation and data visualization.
