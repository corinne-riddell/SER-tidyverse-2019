...
This code installs the R package named `tidyverse`. This packages is a package
of packages! It includes the two that we highlight in detail today, `dplyr` and `ggplot2`. Each package
is a library of functions that are used for data manipulation and data visualization.
